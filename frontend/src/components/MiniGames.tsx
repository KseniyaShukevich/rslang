...
const GAMES: IGame[] = [
  ...
  },
  {
    name: "Аудиовызов",
    image: audioCall,
    description: "Тренировка Аудиовызов улучшает восприятие разговорной речи на слух",
    href: "/audio",
  },
  {
    name: "Спринт",
    image: sprint,
    description:
      "Тренировка Спринт поможет пополнить пассивный словарный запас",
    href: "/sprint",
  },
  {
    name: "Перевод-слово",
    image: ownGame,
    description:
      "Важно уметь подобрать нужное слово в разговоре. Тренировка Перевод-слово развивает активный и пассивный словарный запас",
    href: "/owngame",
  },
];
